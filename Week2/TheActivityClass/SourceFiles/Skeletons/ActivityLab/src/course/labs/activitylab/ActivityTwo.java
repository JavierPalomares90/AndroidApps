...
public class ActivityTwo extends Activity {
	...
	public void onRestart() {
		...
		// TODO: Emit LogCat message
		Log.i(TAG,"Entered theonRestart() method");
	...
	public void displayCounts() {
		mTvCreate.setText("onCreate() calls: " + onCreateCounter);
		mTvStart.setText("onStart() calls: " + onStartCounter);
		mTvResume.setText("onResume() calls: " + onResumeCounter);
		mTvRestart.setText("onRestart() calls: " + onRestartCounter);
